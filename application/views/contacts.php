			...
			<section class="contact-block">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<div class="detail-column">
								<span class="icn-wrap no-shrink element-block">
									<img src="<?php echo  base_url(); ?>assets/images/icon11.png" alt="icon">
								</span>
								<div class="descr-wrap">
									<h3 class="text-uppercase">give us a call</h3>
									<p> <a href="#">(+44)345 678 903</a></p>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4">
							...
							<div class="detail-column">
								<span class="icn-wrap no-shrink element-block">
									<img src="<?php echo  base_url(); ?>assets/images/icon12.png" alt="icon">
								</span>
								<div class="descr-wrap">
									<h3 class="text-uppercase">Send us a Mail</h3>
									<p><a href="adobexd@gmail.com">adobexd@gmail.com</a></p>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4">
							...
							<div class="detail-column">
								<span class="icn-wrap no-shrink element-block">
									<img src="<?php echo  base_url(); ?>assets/images/icon13.png" alt="icon">
								</span>
								<div class="descr-wrap">
				...
				<div class="mapHolder">
					...
					<span class="mapMarker">
						<img src="<?php echo  base_url(); ?>assets/images/map-marker.png" alt="marker">
					</span>
				</div>
				<!-- btn aside block -->
